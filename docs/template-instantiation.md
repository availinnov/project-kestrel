...
Only the two verified timeline UUID payloads are rewritten: user data key 11000
...
Other user data, track identities, bus identities, and stable asset identifiers
remain unchanged.
